...
/*
-- Sample Company
INSERT INTO companies (name, country_code, base_currency, email) VALUES 
('Sample Company Inc.', 'US', 'USD', 'admin@samplecompany.com');

-- Sample Admin User
INSERT INTO users (company_id, name, email, password_hash, role_type) VALUES 
(1, 'Admin User', 'admin@samplecompany.com', 'pbkdf2:sha256:600000$...(hashed)', 'admin');

-- Sample Manager User
INSERT INTO users (company_id, name, email, password_hash, role_type) VALUES 
(1, 'Manager User', 'manager@samplecompany.com', 'pbkdf2:sha256:600000$...(hashed)', 'manager');

-- Sample Employee User
INSERT INTO users (company_id, name, email, password_hash, role_type, manager_id) VALUES 
(1, 'Employee User', 'employee@samplecompany.com', 'pbkdf2:sha256:600000$...(hashed)', 'employee', 2);

-- Sample Approval Sequence
INSERT INTO approval_sequences (company_id, user_id, sequence_order, is_manager_approver) VALUES 
(1, 2, 1, 1); -- Manager as first approver

-- Sample Approval Rule
INSERT INTO approval_rules (company_id, category, max_amount, requires_receipt, approval_levels) VALUES 
(1, 'Travel', 1000.00, 1, 1);
*/
